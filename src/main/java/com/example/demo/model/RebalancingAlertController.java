...
public class RebalancingAlertRecordController {
    ...
    public List<RebalancingAlertRecordModel> getByInvestor(@PathVariable Long investorId) {
        return service.getByInvestor(investorId);
    }

    @PutMapping("/resolve/{alertId}")
    public RebalancingAlertRecordModel resolve(@PathVariable Long alertId) {
